 ...
 * @author rehte
 */
public class CenterAlignmentAction extends AbstractDesignerAction {

    public CenterAlignmentAction(SwingDesigner designer) {
        super(designer);
        setEnabled(false);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (designer.getSelectionModel().isBoundsAdjustable()) {
            designer.getSelectionModel().adjustCenterAlignment();
