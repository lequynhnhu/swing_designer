 ...
 * @author rehte
 */
public class RightAlignmentAction extends AbstractDesignerAction {

    public RightAlignmentAction(SwingDesigner designer) {
        super(designer);
        setEnabled(false);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (designer.getSelectionModel().isBoundsAdjustable()) {
            designer.getSelectionModel().adjustRightAlignment();
