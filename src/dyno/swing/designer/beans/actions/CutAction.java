 ...
 * @author rehte
 */
public class CutAction extends AbstractDesignerAction{
    public CutAction(SwingDesigner designer){
        super(designer);
        setEnabled(false);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        designer.getSelectionModel().cutSelectedComponent2ClipBoard();        
    }

    protected String getDescription() {
        return "Cut Selected Components";
    }
