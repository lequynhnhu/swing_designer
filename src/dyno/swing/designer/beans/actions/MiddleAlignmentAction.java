 ...
 * @author rehte
 */
public class MiddleAlignmentAction extends AbstractDesignerAction{
    public MiddleAlignmentAction(SwingDesigner designer){
        super(designer);
        setEnabled(false);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (designer.getSelectionModel().isBoundsAdjustable()) {
            designer.getSelectionModel().adjustMiddleAlignment();
